...
import About2 from "../../public/team2.jpg"
import About3 from "../../public/about3.png"
import Icon from "../../public/n_icon.ico"
    ...
    return (
        <div className="px-5 md:px-8 py-16 w-full relative space-y-8 lg:space-y-12">
            ...
            <div className="leading-relaxed" data-aos="fade-in" data-aos-duration="2000" data-aos-delay="100" >
                ...
                <br /><br />
                At Accomate Global, our focus is on building long-lasting partnerships. Whether you require dependable financial services or expert loan processing support, we are committed to ensuring that your operations run seamlessly, so you can concentrate on what matters most—growing your business.
            </div>
        </div>
    )
}
